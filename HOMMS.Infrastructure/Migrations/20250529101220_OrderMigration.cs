        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Food_Categories_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSetDish = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsAddOn = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ForPatient = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    PriceForGuest = table.Column<int>(type: "int", nullable: true),
                    PriceForPatient = table.Column<int>(type: "int", nullable: true),
                    PriceForStaff = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountFrom = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    DiscountTo = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    IsQty = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Menu_Details_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Menu_Details_Menus_MenuId",
                        column: x => x.MenuId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Food_Categories_BranchId",
                table: "Food_Categories",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_Food_Categories_BranchId_Name",
                table: "Food_Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Menu_Details_FoodId",
                table: "Menu_Details",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Details_MenuId",
                table: "Menu_Details",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_Menu_Details_MenuId_FoodId",
                table: "Menu_Details",
