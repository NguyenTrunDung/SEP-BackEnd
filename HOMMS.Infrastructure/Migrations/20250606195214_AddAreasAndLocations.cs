...
{
    /// <inheritdoc />
    public partial class AddAreasAndLocations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Areas_BranchId_Name",
                table: "Areas",
                columns: new[] { "BranchId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Areas_BranchId_Sort",
                table: "Areas",
                columns: new[] { "BranchId", "Sort" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_AreaId_Name",
                table: "Locations",
                columns: new[] { "AreaId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Locations_AreaId_Sort",
                table: "Locations",
                columns: new[] { "AreaId", "Sort" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_BranchId_RoomNumber",
                table: "Locations",
