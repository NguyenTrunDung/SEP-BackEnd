...
namespace HOMMS.Infrastructure.Migrations
{
    ...
    [Migration("20250827222446_MakeFoodIdNullableInDiseaseCategoryFoodRestrictions")]
    partial class MakeFoodIdNullableInDiseaseCategoryFoodRestrictions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HOMMS.Domain.Entities.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HOMMS.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("HOMMS.Domain.Entities.Department", "department")
                        .WithMany("user")
