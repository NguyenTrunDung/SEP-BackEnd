...
namespace HOMMS.Infrastructure.Seeds
{
    public static class FoodSeedData
    {
        public static async Task SeedFoodsAsync(IServiceProvider serviceProvider)
        {
            ...
            {
                new Food { Name = "Bún Riêu (370g)", BranchId = 1, CategoryId = 1, Description = "Bún tươi 100g, chả cua 35g, thịt 50g, huyết 10g, đậu hủ 10g, cà chua 5g, rau 10g, nước dùng 150g", IsSetDish = false, IsAddOn = false, ForPatient = false, PriceForGuest = 25000, PriceForPatient = 20000, PriceForStaff = 20000, Image = "images/Foods/0d3bd1b5-09cd-4e21-a7bf-2c20769eb222.png", Sort = 1 },
                ...
                new Food { Name = "Bắp cải xào cà rốt (25,5g)", BranchId = 1, CategoryId = 2, Description = "Bắp cải 20g, cà rốt 5g, hành lá 0.5g", IsSetDish = false, IsAddOn = false, ForPatient = false, PriceForGuest = 10000, PriceForPatient = 8000, PriceForStaff = 8000, Image = "images/Foods/3998ca77-51f7-4aa1-9aac-de56fcb4f2e4.png", Sort = 4 },
                new Food { Name = "Trái cây", BranchId = 1, CategoryId = 2, Description = "80g", IsSetDish = false, IsAddOn = false, ForPatient = false, PriceForGuest = 5000, PriceForPatient = 5000, PriceForStaff = 5000, Image = "images/Foods/6152da49-c0a6-4104-9be3-bc3e05d95c34.jpg", Sort = 5 },
